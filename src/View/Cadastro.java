...
public class Cadastro extends javax.swing.JFrame {
    ...
    public Cadastro() {
        initComponents();
        CadastroController = new ControllerCadastro(this);
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/fsdfasdf.png"))); // NOI18N

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jPanel1.setBackground(new java.awt.Color(1, 198, 81));
        ...
        jLabel2.setMaximumSize(new java.awt.Dimension(79, 33));
        jLabel2.setMinimumSize(new java.awt.Dimension(79, 33));
        ...
        jButton2.setBackground(new java.awt.Color(1, 198, 81));
        ...
        jLabel5.setText("Ainda não tenho uma conta");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/fsdfasdf.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        CadastroController.salvarUsuario();
